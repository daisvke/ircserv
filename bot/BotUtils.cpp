...
/*   Updated: 2022/12/08 22:13:07 by lchan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::vector<std::string>	botSplit(std::string str, int index)
{
	std::vector<std::string>	segmentVect;

	segmentVect = ircSplit(str, ' ');
	segmentVect.erase (segmentVect.begin(),segmentVect.begin() + index);
	return (segmentVect);
}
...
//extract a string until \r\n. returns a empty string if no "\n\r" have been found
